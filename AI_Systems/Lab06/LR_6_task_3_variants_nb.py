...
COND = {"outlook":"Overcast","humidity":"High","wind":"Weak"}  # 1/6/11
...
def main():
    ap = argparse.ArgumentParser(description="NB для варіантів 1,6,11 (Overcast, High, Weak)")
    ...
    if not args.no_header:
        print("Варіанти: 1, 6, 11 — умова Outlook=Overcast, Humidity=High, Wind=Weak")
